...
public class CCSaleReversalService  implements java.io.Serializable {
    private java.lang.String saleRequestID;

    private java.lang.String run;  // attribute

    public CCSaleReversalService() {
    }
    ...
    /**
     * Gets the saleRequestID value for this CCSaleReversalService.
     * 
    ...
    /**
     * Sets the saleRequestID value for this CCSaleReversalService.
     * 
     * @param saleRequestID
     */
    ...
    /**
     * Gets the run value for this CCSaleReversalService.
     * 
     * @return run
     */
    ...
    /**
     * Sets the run value for this CCSaleReversalService.
     * 
     * @param run
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CCSaleReversalService)) return false;
        CCSaleReversalService other = (CCSaleReversalService) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CCSaleReversalService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "CCSaleReversalService"));
