...
public class ExportService  implements java.io.Serializable {
    ...
    private java.lang.String sanctionsLists;
    ...
    public ExportService(
           ...
           java.lang.String sanctionsLists,
    ...
    /**
     * Gets the sanctionsLists value for this ExportService.
     * 
     * @return sanctionsLists
     */
    public java.lang.String getSanctionsLists() {
        return sanctionsLists;
    }


    /**
     * Sets the sanctionsLists value for this ExportService.
     * 
     * @param sanctionsLists
     */
    public void setSanctionsLists(java.lang.String sanctionsLists) {
        this.sanctionsLists = sanctionsLists;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.sanctionsLists==null && other.getSanctionsLists()==null) || 
             (this.sanctionsLists!=null &&
              this.sanctionsLists.equals(other.getSanctionsLists()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSanctionsLists() != null) {
            _hashCode += getSanctionsLists().hashCode();
        }
        if (getRun() != null) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "ExportService"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "addressOperator"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "addressWeight"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "companyWeight"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "nameWeight"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sanctionsLists");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "sanctionsLists"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
