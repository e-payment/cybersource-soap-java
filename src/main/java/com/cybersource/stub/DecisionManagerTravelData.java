...
public class DecisionManagerTravelData  implements java.io.Serializable {
    private com.cybersource.stub.DecisionManagerTravelLeg[] leg;
    ...
    public DecisionManagerTravelData(
           com.cybersource.stub.DecisionManagerTravelLeg[] leg,
     ...
     * @return leg
     */
    public com.cybersource.stub.DecisionManagerTravelLeg[] getLeg() {
        return leg;
    }
     ...
     * @param leg
     */
    public void setLeg(com.cybersource.stub.DecisionManagerTravelLeg[] leg) {
        this.leg = leg;
    }

    public com.cybersource.stub.DecisionManagerTravelLeg getLeg(int i) {
        return this.leg[i];
    }

    public void setLeg(int i, com.cybersource.stub.DecisionManagerTravelLeg _value) {
        this.leg[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "DecisionManagerTravelData"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "DecisionManagerTravelLeg"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("departureDateTime");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "departureDateTime"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "completeRoute"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
