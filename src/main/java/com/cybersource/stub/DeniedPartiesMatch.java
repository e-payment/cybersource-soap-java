...
public class DeniedPartiesMatch  implements java.io.Serializable {
    ...
    /**
     * Gets the program value for this DeniedPartiesMatch.
     * 
     * @return program
     */
    ...
    /**
     * Sets the program value for this DeniedPartiesMatch.
     * 
     * @param program
     */
    ...
    public java.lang.String getProgram(int i) {
        return this.program[i];
    }

    public void setProgram(int i, java.lang.String _value) {
        this.program[i] = _value;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.program==null && other.getProgram()==null) || 
             (this.program!=null &&
              java.util.Arrays.equals(this.program, other.getProgram())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getProgram() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getProgram());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getProgram(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "DeniedPartiesMatch"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("list");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "list"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "program"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
