/**
 * APBillingAgreementService.java
 *
...
public class APBillingAgreementService  implements java.io.Serializable {
    private java.lang.String sessionsRequestID;

    private java.lang.String run;  // attribute

    public APBillingAgreementService() {
    }
    ...
    /**
     * Gets the sessionsRequestID value for this APBillingAgreementService.
     * 
    ...
    /**
     * Sets the sessionsRequestID value for this APBillingAgreementService.
     * 
    ...
    /**
     * Gets the run value for this APBillingAgreementService.
     * 
     * @return run
     */
    ...
    /**
     * Sets the run value for this APBillingAgreementService.
     * 
     * @param run
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof APBillingAgreementService)) return false;
        APBillingAgreementService other = (APBillingAgreementService) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(APBillingAgreementService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "APBillingAgreementService"));
