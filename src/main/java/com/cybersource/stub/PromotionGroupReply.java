...
public class PromotionGroupReply  implements java.io.Serializable {
    private java.lang.String discountApplied;

    private java.math.BigInteger id;  // attribute

    public PromotionGroupReply() {
    }
    ...
    /**
     * Gets the discountApplied value for this PromotionGroupReply.
     * 
    ...
    /**
     * Sets the discountApplied value for this PromotionGroupReply.
     * 
    ...
    /**
     * Gets the id value for this PromotionGroupReply.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this PromotionGroupReply.
     * 
     * @param id
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PromotionGroupReply)) return false;
        PromotionGroupReply other = (PromotionGroupReply) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PromotionGroupReply.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "PromotionGroupReply"));
