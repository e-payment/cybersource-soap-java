/**
 * TransactionMetadataService.java
 *
...
public class TransactionMetadataService  implements java.io.Serializable {
    ...
    /**
     * Gets the authRequestID value for this TransactionMetadataService.
     * 
    ...
    /**
     * Sets the authRequestID value for this TransactionMetadataService.
     * 
     * @param authRequestID
     */
    ...
    /**
     * Gets the run value for this TransactionMetadataService.
     * 
     * @return run
     */
    ...
    /**
     * Sets the run value for this TransactionMetadataService.
     * 
     * @param run
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TransactionMetadataService)) return false;
        TransactionMetadataService other = (TransactionMetadataService) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TransactionMetadataService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "TransactionMetadataService"));
