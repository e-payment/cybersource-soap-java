...
public class CCAuthReversalService  implements java.io.Serializable {
    ...
    public CCAuthReversalService(
           ...
           java.lang.String reversalReason,
    ...
    /**
     * Gets the reversalReason value for this CCAuthReversalService.
     * 
    ...
    /**
     * Sets the reversalReason value for this CCAuthReversalService.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "CCAuthReversalService"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "reversalReason"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
