...
public class CCCreditReply  implements java.io.Serializable {
    ...
    /**
     * Gets the ownerMerchantID value for this CCCreditReply.
     * 
    ...
    /**
     * Sets the ownerMerchantID value for this CCCreditReply.
     * 
    ...
    /**
     * Gets the reconciliationReferenceNumber value for this CCCreditReply.
     * 
    ...
    /**
     * Sets the reconciliationReferenceNumber value for this CCCreditReply.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "CCCreditReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "purchasingLevel3Enabled"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
