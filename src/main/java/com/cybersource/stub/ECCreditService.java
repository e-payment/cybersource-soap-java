...
public class ECCreditService  implements java.io.Serializable {
    ...
    /**
     * Gets the effectiveDate value for this ECCreditService.
     * 
    ...
    /**
     * Sets the effectiveDate value for this ECCreditService.
     * 
     * @param effectiveDate
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "ECCreditService"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "debitRequestToken"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
