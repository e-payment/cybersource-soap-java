...
public class FXRatesReply  implements java.io.Serializable {
    ...
    private com.cybersource.stub.FXQuote[] quote;
    ...
    public FXRatesReply(
           ...
           com.cybersource.stub.FXQuote[] quote) {
     ...
     * @return quote
     */
    public com.cybersource.stub.FXQuote[] getQuote() {
        return quote;
    }
     ...
     * @param quote
     */
    public void setQuote(com.cybersource.stub.FXQuote[] quote) {
        this.quote = quote;
    }

    public com.cybersource.stub.FXQuote getQuote(int i) {
        return this.quote[i];
    }

    public void setQuote(int i, com.cybersource.stub.FXQuote _value) {
        this.quote[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "FXRatesReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "quote"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "FXQuote"));
