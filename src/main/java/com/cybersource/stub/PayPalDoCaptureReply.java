...
public class PayPalDoCaptureReply  implements java.io.Serializable {
    ...
    /**
     * Gets the paypalPendingReason value for this PayPalDoCaptureReply.
     * 
    ...
    /**
     * Sets the paypalPendingReason value for this PayPalDoCaptureReply.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "PayPalDoCaptureReply"));
