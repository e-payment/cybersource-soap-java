...
public class APCancelService  implements java.io.Serializable {
    private java.lang.String orderRequestID;

    private java.lang.String run;  // attribute

    public APCancelService() {
    }
    ...
    /**
     * Gets the orderRequestID value for this APCancelService.
     * 
    ...
    /**
     * Sets the orderRequestID value for this APCancelService.
     * 
    ...
    /**
     * Gets the run value for this APCancelService.
     * 
     * @return run
     */
    ...
    /**
     * Sets the run value for this APCancelService.
     * 
     * @param run
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof APCancelService)) return false;
        APCancelService other = (APCancelService) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(APCancelService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "APCancelService"));
