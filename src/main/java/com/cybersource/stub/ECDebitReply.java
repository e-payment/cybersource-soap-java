...
public class ECDebitReply  implements java.io.Serializable {
    ...
    /**
     * Gets the ownerMerchantID value for this ECDebitReply.
     * 
    ...
    /**
     * Sets the ownerMerchantID value for this ECDebitReply.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.141", "ECDebitReply"));
